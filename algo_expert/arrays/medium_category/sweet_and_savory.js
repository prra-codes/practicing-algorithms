...
// Time: O(nlog(n)), where is n the total of sweet and savory dishes put together (total number of dishes), and we going over the array o(n), but because we sort the array, it's O(nlog(n))

// Space O(n), because we need to create the arrays of sweet and savory
